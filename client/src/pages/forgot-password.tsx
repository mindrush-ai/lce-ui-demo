        ...
        <div className="min-h-screen flex flex-col">
          ...
          <main className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
            <div className="w-full max-w-md space-y-8">
              <div className="animate-fade-in" data-testid="success-state">
            ...
            <div className="animate-fade-in" data-testid="forgot-password-form">
              <div className="bg-slate-800/50 dark:bg-slate-800/50 backdrop-blur-sm rounded-2xl shadow-2xl border border-slate-700/50 dark:border-slate-700/50 p-8">
                ...
                <div className="mt-6 text-center">
                  <Link href="/login">
                    <div className="inline-flex items-center text-sm text-blue-400 dark:text-blue-400 hover:text-blue-300 dark:hover:text-blue-300 transition-colors duration-200 cursor-pointer" data-testid="link-back-to-login">
      ...
      {isLoading && (
        <div className="fixed inset-0 bg-slate-900/80 dark:bg-slate-900/80 backdrop-blur-sm z-50 flex items-center justify-center" data-testid="loading-overlay">
          <div className="bg-slate-800 dark:bg-slate-800 rounded-xl p-6 flex items-center space-x-3">
            ...
            <span className="text-slate-200 dark:text-slate-200">Sending reset link...</span>
          </div>
        </div>
      )}
    </div>
